...
Hi <?php echo $userRow['userName' ]; ?>
    ...
    <h3 class="text-center">Here you will find our more mature friends...</h3>
    <table class="table table-bordered mt-5 bg-info text-white">
       ...
       <?php
           $sql = "SELECT * FROM pets WHERE age >='10 years'";
    ...
    <a href= "index.php"><button type="button" class="btn btn-info">Back to Main Page</button></a>
    <a href= "general.php"><button type="button" class="btn btn-info">To our younger friends</button></a>
</div>
