...
Hi <?php echo $userRow['userName' ]; ?>
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                   echo  "<tr>
                       ...
                       <td>" .$row['location']."</td>
                       <td>
                           <a href='update.php?id=" .$row['petsId']."'><button type='button' class='btn btn-info mb-3 w-100'>Edit</button></a>
                           <a href='delete.php?id=" .$row['petsId']."'><button type='button' class='btn btn-info mb-3 w-100'>Delete</button></a>
                       </td>
                   </tr>" ;
               }
           } else  {
    ...
    <a href= "create.php"><button type="button" class="btn btn-info mb-4">Add Pet</button></a>
</div>
